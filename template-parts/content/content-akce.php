...
$hb_configuration = $hb_container->getConfiguration();
...
<?php 
function hb_detail_application(EventDC $event) 
{ 
	global $hb_configuration;
	$url = $hb_configuration->get('bis:applicationUrlTemplate');
		...
		<?php else: ?>
			...
			<div class="detail__top hb-mbs-4 hb-d-f hb-fd-c hb-lg-fd-r hb-lg-ai-c hb-br hb-bg-tinge hb-mbe-5">
				<div class="detail__labels-wrapper">
					...
					<div class="detail__labels hb-pi-2 hb-pbe-2 hb-ta-c">
			...
			<div class="hb-mbe-5">
				<div class="registration">
					...
					<?php else: ?>
                        <?php hb_detail_application($event) ?>
					<?php endif; ?>
				</div>
			</div>
