...
/**
 * @var array<stdClass{image: string, title: string, text: string}> $stories
 */
$stories = [
    (object) [
...
/** @var array<stdClass{title: string, text: string, image: string}> $references */
$references = [
    (object) [
        'name' => 'Zdeněk Frélich',
        'role' => 'poradce pro oblast životního prostředí',
        'quotation' => 'Adoptoval jsem Brontosaura, protože chci, aby byl nezávislý.',
        'image' => 'https://brontosaurus.cz/wp-content/uploads/2024/12/supportOverview-supporters-frelich.jpg',
    ],
    (object) [
        ...
        'image' => 'https://brontosaurus.cz/wp-content/uploads/2024/12/supportOverview-supporters-brzobohata.jpg',
    ],
    (object) [
        'name' => 'Martin Perlík',
    ...
    (object) [
        ...
        'image' => 'https://brontosaurus.cz/wp-content/uploads/2024/12/supportOverview-supporters-hladky.jpg',
    ],
    (object) [
        'name' => 'Tibor Vansa',
        ...
        'image' => 'https://brontosaurus.cz/wp-content/uploads/2024/12/supportOverview-supporters-vansa.jpg',
    ],
    (object) [
        'name' => 'Roman Zemánek',
        ...
        'image' => 'https://brontosaurus.cz/wp-content/uploads/2024/12/supportOverview-supporters-zemanek.jpg',
    ],
];
...
?><main class="supportOverview b-mbe-6 hb-lg-mbe-7" role="main">
	<section>
		...
		<p class="hb-block-text hb-mbe-3">
			Už padesát let zapojujeme mladé lidi do dobrovolnických činností
			a pečujeme s nimi o přírodu a památky. Přispíváme k řešení
			ztráty pestrosti přírody, dopadů sucha a změn počasí, či chátrání památek.
			Necháváme za sebou vysázená stromořadí, opravené hrady, obnovené mokřady.
			Pojď do toho s námi!
		</p>
	</section>
	...
	<section class="supportOverview__thanks hb-mi-auto">
		<h1>
			Co dokážeme s tvou podporou za jeden rok?
		</h1>

		<ul class="hb-lst-n hb-jc-c hb-lg-ji-c hb-lg-mi-auto">
			<li class="icon-tree">postaráme se o 1 500 ptačích budek a vysadíme a opečujeme stovky stromů</li>
			<li class="icon-people">umožníme 2 200 mladým lidem pomáhat přírodním a historickým památkám</li>
			<li class="icon-earth">odpracujeme 120 000 dobrovolnických hodin a pomůžeme na 90 místech</li>
			<li class="icon-hand">uspořádáme na 650 akcí pro přírodu, památky a lidi</li>
		</ul>
	</section>
	...
	<section>
		...
		<p class="hb-block-text hb-mbe-4">
			Již 50 let pomáháme přírodě, památkám a lidem. Koukni na Příběhy nadšení a zjisti, proč našim členům,
			organizátorům a dárcům dává Brontosaurus smysl a dlouhodobě ho podporují.
		</p>

		<div class="hb-eventList hb-eventList--smaller hb-mbe-4">
			<div class="hb-eventList__grid">
                <?php foreach ($stories as $story): ?>
				<a class="hb-event" href="<?php echo $story->link ?>">
					<div class="hb-event__imageWrapper">
						<img alt="" class="hb-event__image" data-src="<?php echo $story->image ?>">
					</div>
