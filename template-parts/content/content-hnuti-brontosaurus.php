...
?><main role="main">
	<article>
		...
		<div class="hb-lg-mw-40 [ hb-d-f hb-lg-jc-c hb-ai-c ][ hb-lg-mi-auto hb-mbe-5 ]">
			...
			<div class="about__graphics brontographics">
				<svg
				...
				>
					...
					<a xlink:href="#kluby">
						...
						<text class="brontographics__label" id="about-structure-image-clubs" x="77.026" y="429.509">Kluby</text>
					</a>
					...
					<a xlink:href="#regionalni-centra">
						...
						<text class="brontographics__label" id="about-structure-image-regional" x="272.348" y="674.216">Regionální centra</text>
					</a>
					...
					<a xlink:href="#ustredi">
						...
						<text class="brontographics__label" id="about-structure-image-office" x="245.611" y="194.479">Ústředí</text>
					</a>
					...
					<a xlink:href="#detske-oddily">
						...
						<text class="brontographics__label" id="about-structure-image-children" x="482.47" y="440">
							Dětské
					...
					<a xlink:href="#dobrovolnici">
						...
						<text class="brontographics__label" id="about-structure-image-volunteers" x="436.043" y="389.852">Dobrovolníci</text>
					</a>
				</svg>
			</div>
		</div>
		...
		<a class="action action--ulterior" href="https://www.mapotic.com/lokality-hnuti-brontosaurs" rel="noopener noreferrer" target="_blank">
